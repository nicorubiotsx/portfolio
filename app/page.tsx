  ...
  return (
    ...
    <>
      <header id="cabezera" className="flex flex-col items-center justify-center min-h-screen">
        <h1 className="text-center text-2xl md:text-6xl text-white font-semibold mb-12">
      ...
      <div className="contenedor">
        ...
        <div className="content">
          ...
          <div className="mt-16 experience-detail">
            <h3 className="text-lg font-semibold">asdasdasd</h3>
            <p className="mt-2 mb-4">asdasd</p>
            <ul className="list-disc pl-5 space-y-2">
